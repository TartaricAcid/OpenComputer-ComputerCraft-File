----------------------------------------------------------
--这个程序是由mc工业2吧吧友babydjxdh制作的
--用OC来检测控制IC反应堆
--原帖发布地址：http://tieba.baidu.com/p/4942855975
----------------------------------------------------------
...
local reactor = component.reactor_chamber --反应堆
local gpu = component.gpu --显卡

reactor_heat=component.reactor_chamber.getHeat() --获取反应堆初始温度
reactor_maxheat=component.reactor_chamber.getMaxHeat()
...
for a=1,n		
	...
	reactor_heat_now=component.reactor_chamber.getHeat()--获取反应堆温度
